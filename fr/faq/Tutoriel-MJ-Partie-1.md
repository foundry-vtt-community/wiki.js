...
Utilisé pour basculer entre les scènes actuellement disponibles.
...
Utilisé pour changer d'outil sur vos [scènes](https://foundryvtt.com/article/scenes/) afin de contrôler les différents objets placés sur le canevas. Chacun de icônes de contrôle fournit différent outils. Les outils de contrôle disponibles et que les joueurs peuvent utiliser incluent :
...
Barres latérales des répertoires
...
Cet onglet donne accès à la barre latérale [Cartes](https://foundryvtt.com/article/cards/) , qui stocke les jeux de cartes, les mains et les pioches dont les utilisateurs auront besoin pour utiliser les cartes.
